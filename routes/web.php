...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/system-subjects', [SubjectController::class,'sysSubjects'])->name('subjects.system');
    Route::post('/system-subjects-save', [SubjectController::class,'sysSubjectSave'])->name('subjects.system.save');
    ...
    Route::group(['namespace' => 'SupportTeam'], function(){
        ...
        Route::post('get-teachers',[SubjectController::class,'getTeachers'])->name('teachers.get');
