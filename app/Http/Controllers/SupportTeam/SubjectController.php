...
class SubjectController extends Controller
{
    ...
    public function sysSubjects(){
        $data['subjects'] =  SystemSubject::all();
        return view('pages.support_team.subjects.systemSubjects',$data);
    }

    public function sysSubjectSave(Request $req){
        $req->validate([
            'name' => 'required|string',
            'short_name' => 'required|string'
        ]);
        SystemSubject::create([
            'name' => $req->name,
            'slug' => $req->short_name
        ]);
    }
