...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function getSubjTeam(){
        return ['admin', 'super_admin', 'director', 'censor'];
    }
    ...
    public static function userIsSubjTeam()
    {
        return in_array(Auth::user()->user_type, self::getSubjTeam());
    }
